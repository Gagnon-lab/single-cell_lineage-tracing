...
```{r check diff.scores were added appropriately}
FeaturePlot(unedited, "diff.score", cols = c('red', 'orange', 'yellow', 'green', 'blue','purple'))
FeaturePlot(edited, "diff.score", cols = c('red', 'orange', 'yellow', 'green', 'blue','purple'))
```
